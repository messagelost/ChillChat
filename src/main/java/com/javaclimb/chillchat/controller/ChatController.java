    ...
    public void downloadFile(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (!StringTools.isNumber(fileId)) {
                String avatarFolderName = Consts.FILE_FOLDER_FILE + Consts.FILE_FOLDER_AVATAR_NAME;
                String avatarPath = appConfig.getProjectFolder() + avatarFolderName + fileId + Consts.IMAGE_SUFFIX;
                if (showCover) {
                    avatarPath = avatarPath + Consts.COVER_IMAGE_SUFFIX;
                }
