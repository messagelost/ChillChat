...
import com.javaclimb.chillchat.entity.dto.WsInitData;
import com.javaclimb.chillchat.entity.enums.MessageTypeEnum;
import com.javaclimb.chillchat.entity.enums.UserContactApplyStatusEnum;
...
import com.javaclimb.chillchat.utils.JsonUtils;
...
public class ChannelContextUtils {
    ...
    public void addContext(String userId, Channel channel) {
        try {
            ...
            if (sourceLastOffTime != null && System.currentTimeMillis() - Consts.MILLISECOND_3DAYS_AGO > sourceLastOffTime) {
                lastOffTime = Consts.MILLISECOND_3DAYS_AGO;
            }
