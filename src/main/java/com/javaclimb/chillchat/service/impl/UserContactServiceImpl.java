...
public class UserContactServiceImpl implements UserContactService {
	...
	public void addContact(String applyUserId, String receiveUserId, String contactId, Integer contactType, String applyInfo) {
		...
		if (UserContactTypeEnum.USER.getType().equals(contactType)) {
			...
			applySessionUser.setLastReceiveTime(curDate.toString());
			...
			contactSessionUser.setLastReceiveTime(curDate.toString());
	...
	public void removeUserContact(String userId, String contactId, UserContactStatusEnum statusEnum) {
		...
		} else if (UserContactStatusEnum.BLOCK == statusEnum) {
			friendContact.setStatus(UserContactStatusEnum.BLOCK_BE.getStatus());
		}
